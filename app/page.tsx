          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.tiktok.com/@limenlaky" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-600 hover:text-amber-500 dark:hover:text-amber-500 transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
